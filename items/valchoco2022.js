module.exports = {
    name: 'valentine chocolate 2022',
    async execute(message, args, BotClient, functions, user) {
        const item = await functions.getItemByName('valentine chocolate 2022 (gifted)')
        ...
        message.reply("You showed your true love and used **Valentine Chocolate 2022**!");
    }
}